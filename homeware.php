...
<head>
    ...
    <link rel="stylesheet" href="css/homeware.css">
</head>
<body>
<header>
    <div class="logo">
...
<!------------------------------------------------------ Homeware Page Starts -------------------------------------------->
<div class="product-grid">
    <?php
    // $query = "SELECT * FROM `products` WHERE status = 'Home' ORDER BY RAND() LIMIT 4";
    $query = "SELECT * FROM `products` WHERE status = 'Home' LIMIT 4";
...
<div class="product-grid">
    <?php
    // $query = "SELECT * FROM `products` WHERE status = 'Table' ORDER BY RAND() LIMIT 4";
    $query = "SELECT * FROM `products` WHERE status = 'Table' LIMIT 4";
    $result = mysqli_query($conn, $query) or die(mysqli_error($conn));
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            $id = $row['id'];
