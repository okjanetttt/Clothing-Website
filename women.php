...
<head>
    ...
    <title>Women - Queens & Kings Streetfashion</title>
...
<!------------------------------------------------------ Women Products Starts -------------------------------------------->
<div class="product-grid">
    <?php
    $query = "SELECT * FROM `products` WHERE status = 'Used' LIMIT 4";
...
<div class="product-grid">
    <?php
    // $query = "SELECT * FROM `products` WHERE status = 'Ussed' ORDER BY RAND() LIMIT 4";
    $query = "SELECT * FROM `products` WHERE status = 'Ussed' LIMIT 4";
    $result = mysqli_query($conn, $query) or die(mysqli_error($conn));
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            $id = $row['id'];
...
<div class="product-grid">
    <?php
    // $query = "SELECT * FROM `products` WHERE status = 'Use' ORDER BY RAND() LIMIT 4";
    $query = "SELECT * FROM `products` WHERE status = 'Use' LIMIT 4";
    $result = mysqli_query($conn, $query) or die(mysqli_error($conn));
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            $id = $row['id'];
