...
<head>
    ...
    <title>New Arrivals - Queens & Kings Streetfashion</title>
...
<header>
    ...
    <nav>
        <ul>
            <li class="active"><a href="new-arrivals.php">New Arrivals</a></li>
    ...
    <div class="user-actions">
        <a href="#">Sign In</a>
        <a href="#">Login</a>
        <a href="cart.php"><div class="cart-icon"><i class="fas fa-shopping-cart"></i></div></a>
    </div>
</header>
...
<div class="product-grid">
    <?php
    // $query = "SELECT * FROM `products` WHERE status = 'New' ORDER BY RAND() LIMIT 4";
    $query = "SELECT * FROM `products` WHERE status = 'New' LIMIT 4";
...
<div class="product-grid">
    <?php
    // $query = "SELECT * FROM `products` WHERE status = 'News' ORDER BY RAND() LIMIT 4";
    $query = "SELECT * FROM `products` WHERE status = 'News' LIMIT 4";
    $result = mysqli_query($conn, $query) or die(mysqli_error($conn));
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            $id = $row['id'];
